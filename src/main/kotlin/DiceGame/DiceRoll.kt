...
data class DiceRoll(
    ...
    fun isFullHouse(): Boolean {
        return (dice[0].value == dice[1].value && dice[2].value == dice[3].value && dice[2].value == dice[4].value ||
                dice[0].value == dice[1].value && dice[0].value == dice[3].value && dice[3].value == dice[4].value)
    }

    fun isSmallStreet(): Boolean {
        return(dice[0].value == dice[1].value-1 && dice[0].value == dice[2].value-2 && dice[0].value == dice[3].value-3 ||
                dice[1].value == dice[2].value-1 && dice[1].value == dice[3].value-2 && dice[1].value == dice[4].value-3)
    }
